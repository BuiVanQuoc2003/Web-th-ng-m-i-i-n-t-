                    ...
                    <div class="product-info">
                        <div class="nav-main">
                            ...
                            <ul class="nav nav-tabs filter-tope-group" id="myTab" role="tablist">
                                ...
                                @endphp
                                @if($categories)
                                <button class="btn" style="background:black"data-filter="*">Tất cả sản phẩm
                                </button>
                                        ...
                                        <div class="product-img">
                                            ...
                                            <div class="button-head">
                                                <div class="product-action">
                                                    <a data-toggle="modal" data-target="#{{$product->id}}" title="Quick View" href="#"><i class=" ti-eye"></i><span>Xem Chi Tiết Sản Phẩm</span></a>
                                    ...
                                    <div class="quickview-content">
                                        ...
                                        <div class="quickview-ratting-review">
                                            ...
                                            <div class="quickview-stock">
                                                ...
                                                @else
                                                <span><i class="fa fa-times-circle-o text-danger"></i> {{$product->stock}} Ngoài Kho</span>
                                                @endif
                                            </div>
                                        </div>
                                        @php
