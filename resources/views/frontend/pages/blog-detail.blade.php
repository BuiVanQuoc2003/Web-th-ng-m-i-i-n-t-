                        ...
                        <div class="row">
                            <div class="col-12">
                                ...
                                <div class="blog-detail">
                                    ...
                                    <div class="blog-meta">
                                        <span class="author"><a href="javascript:void(0);"><i class="fa fa-user"></i> {{$post->author_info['name']}}</a><a href="javascript:void(0);"><i class="fa fa-calendar"></i>{{$post->created_at->format('M d, Y')}}</a><a href="javascript:void(0);"><i class="fa fa-comments"></i>Comment ({{$post->allComments->count()}})</a></span>
                                    </div>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-12">
                                                    <div class="form-group  comment_form_body">
                                                        <label>Nhập Bình Luận<span>*</span></label>
                                                ...
                                                <div class="col-12">
                                                    <div class="form-group button">
                                                        <button type="submit" class="btn"><span class="comment_btn comment">
                                                            Đăng bình luận</span><span class="comment_btn reply" style="display: none;">Trả lời Bình luận</span></button>
                                                    </div>
                                                </div>
                                            </div>
                                        </form>
                            ...
                            <p class="text-center p-5">
                                Bạn cần phải <a href="{{route('login.form')}}" style="color:rgb(54, 54, 204)">Đăng Nhập</a> Đăng Ký <a style="color:blue" href="{{route('register.form')}}">Đăng Ký</a> để bình luận.
